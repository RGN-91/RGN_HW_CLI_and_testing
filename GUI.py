...
def add_toc():
    ...
    add_to_files_btn.place(relx=0.1, rely=0.25)
    ...
    add_to_all_files_btn.place(relx=0.1, rely=0.475)
...
def add_toc_2():
    fof_path = filedialog.askdirectory()
    if fof_path:
...
add_date_of_creation_btn.place(relx=0.5, rely=0.9, anchor=tk.CENTER, relwidth=0.282)
